...
const Suggestions = () => {
  return (
    <div className="container Suggestions mt-5">
      ...
      <div className="row mt-3 " >
        <div className="col-lg-4">
          ...
          <h2 className="fw-normal fs-3">Plumber</h2>
          <p>
        ...
        <div className="col-lg-4 ">
          ...
          <h2 className="fw-normal fs-3">PG</h2>
          <p>
        ...
        <div className="col-lg-4 ">
         {/* <div className="d-flex  align-items-center flex-column h-100"> */}
          ...
          <h2 className="fw-normal fs-3">Laundary</h2>
          <p>
      ...
      <div className="row featurette">
        <div className="col-md-7">
          ...
          <p className="lead">
            ...
            Again, not really intended to be actually read, simply here to give you
